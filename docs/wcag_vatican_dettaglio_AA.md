...
<div class="success-criteria">
     <h3>Criterio di successo 1.2.4 Sottotitoli (in tempo reale)</h3>

     <p>Per tutti i contenuti audio in tempo reale sotto forma di media sincronizzati sono forniti sottotitoli.</p>
</div>

<div class="success-criteria">
     <h3>Criterio di successo 1.2.5 Audiodescrizione (preregistrata)</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 1.3.4 Orientamento</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 1.3.5 Identificare lo scopo degli input</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 1.4.3 Contrasto (minimo)</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 1.4.4 Ridimensionamento del testo</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 1.4.5 Immagini di testo</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 1.4.10 Ricalcolo del flusso</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 1.4.11 Contrasto in contenuti non testuali</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 1.4.12 Spaziatura del testo</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 1.4.13 Contenuto con Hover o Focus</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 2.4.5 Differenti modalità</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 2.4.6 Intestazioni ed etichette</h3>

     <p>Utilizzare intestazioni ed etichette per descrivere argomenti o finalità.</p>
</div>

<div class="success-criteria">
     <h3>Criterio di successo 2.4.7 Focus visibile</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 3.1.2 Parti in lingua</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 3.2.3 Navigazione coerente</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 3.2.4 Identificazione coerente</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 3.3.3 Suggerimenti per gli errori</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 3.3.4 Prevenzione degli errori (legali, finanziari, dati)</h3>
...
<div class="success-criteria">
     <h3>Criterio di successo 4.1.3 Messaggi di stato</h3>
